...
public class BillingManager implements PurchasesUpdatedListener {
  ...
  private static String[] key = {
          BuildConfig.PLAY_PUB_KEY_2,
          BuildConfig.PLAY_PUB_KEY_4,
          BuildConfig.PLAY_PUB_KEY_6,
          BuildConfig.PLAY_PUB_KEY_5,
          BuildConfig.PLAY_PUB_KEY_3,
          BuildConfig.PLAY_PUB_KEY_1
  };
   ...
   */
  private static final String BASE_64_ENCODED_PUBLIC_KEY = getKey();

  @NonNull
  private static String getKey() {
    return key[5] + key[0] + key[4] + key[1] + key[3] + key[2];
  }
